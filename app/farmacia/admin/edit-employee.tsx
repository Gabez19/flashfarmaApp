...
export default function EditEmployee() {
  ...
  // Dados fictícios carregados para edição
  const [name, setName] = useState("Marina Oliveira");
  const [email, setEmail] = useState("marina.oliveira@example.com");
  const [matricula] = useState("12345");
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <Text style={styles.headerTitle}>Editar Funcionário</Text>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.row}>
            <TextInput
              ...
              style={[styles.input, styles.half, { opacity: 0.5 }]}
              editable={false}
              value={matricula}
            />
            <TextInput
          ...
          <View style={styles.buttonRow}>
            ...
            <TouchableOpacity
              ...
              onPress={() => router.push("/farmacia/admin/exclue-employee")}
            >
