// app/farmacia/admin/exclue-employee.tsx
...
export default function ExclueEmployee() {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <Text style={styles.headerTitle}>Excluir Funcionário</Text>
      ...
      <View style={styles.card}>
        <Text style={styles.textoMaior}>Tem certeza que deseja excluir?</Text>
        ...
        <View style={styles.buttonsRow}>
          ...
          <TouchableOpacity
            ...
            onPress={() => router.push("/farmacia/admin/manage-users")}
          >
