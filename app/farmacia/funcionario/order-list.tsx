// app/farmacia/funcionario/order-list.tsx
...
export default function OrderListFuncionario() {
    ...
    <View style={styles.container}>
      ...
      <FlatList
        ...
        renderItem={({ item }) => {
          ...
          return (
            <TouchableOpacity style={styles.orderCard} onPress={() => router.push("/farmacia/funcionario/order-details")}> 
              <View>
